...
export default function NewUserForm({ setIsNewUser }: NewUserFormProps) {
   return (
      <div className="bg-white p-8 rounded-lg shadow-lg w-80">
         ...
         <form>
            ...
            <div className="flex items-center justify-between">
               ...
               <button type="button" className="text-sm text-blue-500 hover:underline" onClick={() => setIsNewUser(false)}>
                  Back to Login
               </button>
            </div>
         </form>
